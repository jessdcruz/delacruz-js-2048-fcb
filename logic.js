...
function setGame (){
	...
	//Goal, we will use the backend board to design and move the tiles of the front end board.
	...
	for(let r=0; r < rows; r++){
		for(let c=0; c < columns; c++){
			...
			//Each tule will have an id based on its row and colum position through this code.
...
function slideLeft(){
	...
	for (let r=0; r<rows; r++){
		...
		//update the row with merged tile/s
		board[r] = row;
